 ...
 * @author andl
 */
public class TryNumberFormatterNodeModel extends NodeModel {
	 ...
	 */
	private static final NodeLogger LOGGER = NodeLogger.getLogger(TryNumberFormatterNodeModel.class);
	 ...
	 * in the constructor of the {@link TryNumberFormatterNodeDialog} as the settings 
	 ...
	 */
	protected TryNumberFormatterNodeModel() {
		/**
	 ...
	 * format String. This method will also be used in the {@link TryNumberFormatterNodeDialog}. 
