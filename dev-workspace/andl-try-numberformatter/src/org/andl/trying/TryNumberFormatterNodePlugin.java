 ...
 * @author andl
 */
public class TryNumberFormatterNodePlugin extends Plugin {
    // The shared instance.
    private static TryNumberFormatterNodePlugin plugin;

    /**
     * The constructor.
     */
    public TryNumberFormatterNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static TryNumberFormatterNodePlugin getDefault() {
        return plugin;
    }
